...
当前稳定版本：`1.0.4`。`main` 分支当前为 `1.0.5-SNAPSHOT` 开发周期。
...
兼容性策略、支持矩阵和发布前验证命令见 [docs/COMPATIBILITY.md](docs/COMPATIBILITY.md)。当前 `1.0.4` 发布说明见 [docs/releases/v1.0.4.md](docs/releases/v1.0.4.md)。
